 ...
 function BuyerSignup() {
  ...
  <div className="card shadow-sm p-4 bg-light"> {/* Added bg-light for grey background */}
  ...
  Already have an account? <Link to="/login/buyer" style={{color: '#28A745'}}>Log In</Link>
  </p>
  </div>
  </div>
  </div>
